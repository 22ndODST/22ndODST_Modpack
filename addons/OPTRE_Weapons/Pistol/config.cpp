...
class CfgWeapons
{
	...
	class OPTRE_M6G: Pistol_Base_F
	{
		...
		maxRecoilSway=0.0020000001;
		swayDecaySpeed=1.2;
		drySound[]=
		{
			"A3\Sounds_F\weapons\Other\dry6.wss",
			0.1,
			1
		};
		reloadMagazineSound[]=
		{
			"\OPTRE_Weapons\Pistol\data\sounds\reload.ogg",
			1.3,
			1,
			30
		};
		fireSpreadAngle=0.85000002;
	...
	class OPTRE_M6C: OPTRE_M6G
	{
		...
		class Single: Mode_SemiAuto
		{
			...
			class CompSound: BaseSoundModeType
			{
				begin1[]=
				{
					"A3\Sounds_F\arsenal\weapons\Pistols\Acpc2\acpc2_short_01",
					2.5118864,
					1,
					1400
				};
				begin2[]=
				{
					"A3\Sounds_F\arsenal\weapons\Pistols\Acpc2\acpc2_short_02",
					2.5118864,
					1,
					1400
				};
				begin3[]=
				{
					"A3\Sounds_F\arsenal\weapons\Pistols\Acpc2\acpc2_short_03",
					2.5118864,
					1,
					1400
				};
