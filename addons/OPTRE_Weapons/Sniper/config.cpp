...
class CfgWeapons
{
		...
		class ItemInfo: InventoryOpticsItem_Base_F
		{
			...
			class OpticsModes
			{
				class SRS99_Scope_View
				{
					...
					modelOptics[]=
					{
						"\OPTRE_Weapons\Sniper\Sniper_Oracle5_Optic",
	...
	class OPTRE_SRS99D: LMG_Mk200_F
	{
		...
		{
			"OFP2_ManSkeleton",
			"\OPTRE_Weapons\Sniper\data\anim\sniper_handanim.rtm"
		};
		opticsPPEffects[]={};
		opticsDisablePeripherialVision=1;
		opticsFlare=1;
		...
		reloadMagazineSound[]=
		{
			"A3\Sounds_F\weapons\M320\M320_reload.wss",
			1,
			1,
			10
		};
		...
		class Single: Mode_SemiAuto
		{
			...
			class StandardSound: BaseSoundModeType
			{
				begin1[]=
				{
					"\OPTRE_Weapons\Sniper\Data\sounds\SRS99_1.wss",
					5,
					1,
					3000
				};
				begin2[]=
				{
					"\OPTRE_Weapons\Sniper\Data\sounds\SRS99_2.wss",
					5,
					1,
					3000
				};
