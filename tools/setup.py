...
def main():
    ...
    print("""
  ######################################
  # 22nd Development Environment Setup #
  ######################################

  This script will create your 22nd ODST dev environment for you.
  ...
  This script will create two hard links on your system, both pointing to your ACE3 project folder:
    [Arma 3 installation directory]\\{} => 22nd ODST project folder
    P:\\{}                              => 22nd ODST project folder
